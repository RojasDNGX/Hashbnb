      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-8">
        <Link to="/" className="flex items-center">
          <img
            ...
            alt="Logo da Hashtag"
          />
          <p className="text-2xl font-bold text-red-500">ashbnb</p>
        </Link>

        <div className="hidden items-center rounded-full border border-gray-300 px-4 py-2 shadow-md lg:flex">
        ...
        >
          ...
          {user ? (
            <p className="max-w-16 truncate font-semibold sm:max-w-32">
              {user.name}
            </p>
          ) : (
            <></>
